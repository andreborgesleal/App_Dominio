using App_Dominio.ConsultaCNPJ.Models;
using System;

namespace App_Dominio.ConsultaCNPJ.Infra
{
    public class FormatarDados
    {
        public static EmpresaReceitaFederal MontarObjEmpresa(string cnpj, string resp)
        {
            var empresa = new EmpresaReceitaFederal(
